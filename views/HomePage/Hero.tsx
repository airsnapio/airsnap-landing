  ...
  return (
    <HeroWrapper>
      <Contents>
        ...
        <Description>
          AirSnap combines session replay, error tracking, and product analytics - empowering teams to create the ideal mobile experience.
        </Description>
        <CustomButtonGroup>
          ...
          <NextLink href="https://www.loom.com/share/830e7d49a92c46049b0c5237fdd4f440" passHref>
            <Button transparent target="_blank">
